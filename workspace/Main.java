...
public class Main 
{
  ...
  public void loadCountries() 
  {
    ...
    File file = new File("/workspaces/Countries-Game/workspace/countries-data.csv");
    Scanner scan = null;
    try {
  ...
  */
  public void showCountry() {
    outputLabel.setText("What country is this? (first letter uppercase, no spaces)");
    // Get the country at index from countryArray
    // Use its get method to get the its image file name and save it into imagefile variable below instead of worldmap.jpg.
    String imagefile = countryArray[index].getImage();
    // Use the following code to create an new Image Icon and put it into the GUI
    img = new ImageIcon("/workspaces/Countries-Game/workspace/"+imagefile);
    imageLabel.setIcon(img);
  }
  
  /* nextButton should increment index. If the index is greater than 9,
  reset it back to 0. Clear the outputLabel to empty string using setText,
  and call showCountry();*/
  public void nextButtonClick()
  {
    ...
    outputLabel.setText("What country is this? (first letter uppercase)");
    showCountry();
  }
  
  /* reviewButton should get the country at index from the countryArray, 
  ...
  get the country at index from countryArray, print out a question about it like What country is this?
  and/or What's this country's capital?. Get the user's answer using scan.nextLine()
  and check if it is equal to the country's data using its get methods and print out correct or incorrect.
  */
  public void quizButtonClick()
  {
    Country c = countryArray[index];
    String imagefile = c.getName();

    if (input.getText().contentEquals(imagefile)){
